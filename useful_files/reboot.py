...
dxl_error_info, dxl_comm_result, dxl_error = packetHandler.read1ByteTxRx(portHandler, DXL_ID, HARDWARE_ERROR_STATUS)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
    print("%s" % packetHandler.getRxPacketError(dxl_error))
print("This is the final output of the dxl error information:",dxl_error_info)

dxl_comm_result, dxl_error = packetHandler.reboot(portHandler, DXL_ID)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
    print("This is the value of dxl_error",dxl_error)
    print("%s" % packetHandler.getRxPacketError(dxl_error))
