# citation: https://github.com/eldar81/Realtime_pitch_detector/blob/master/console.py
import pyaudio
import crepe
import os
import numpy as np
...
try:
    ...
    while True:
        ...
        # Plot title
        if confidence[0] > 0.7:
            print("This is the real time:",frequency[0])
            ...
            if count == 5:
                ...
                print("I've got the average pitch")
                print(f"This is the average pitch: {'{:.2f}'.format(pitch_frec_total/5)} frequency")
                break
