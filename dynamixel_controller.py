...
if MY_DXL == 'X_SERIES' or MY_DXL == 'MX_SERIES':
    ...
    ADDR_GOAL_POSITION          = 116#596
    ADDR_PRESENT_POSITION       = 132#611
    DXL_MINIMUM_POSITION_VALUE  = 0   # Refer to the Minimum Position Limit of product eManual
    DXL_MAXIMUM_POSITION_VALUE  = 150000    # Refer to the Maximum Position Limit of product eManual
    BAUDRATE                    = 57600
elif MY_DXL == 'P_SERIES' or MY_DXL == 'PRO_A_SERIES':
    
    ADDR_TORQUE_ENABLE          = 64#512        # Control table address is different in DYNAMIXEL model
    ADDR_GOAL_POSITION          = 116#564
    ADDR_PRESENT_POSITION       = 132#580
    DXL_MINIMUM_POSITION_VALUE  = 0 #-150000   # Refer to the Minimum Position Limit of product eManual
    DXL_MAXIMUM_POSITION_VALUE  = 4096 # 150000    # Refer to the Maximum Position Limit of product eManual
    BAUDRATE                    = 57600
elif MY_DXL == 'XL320':
